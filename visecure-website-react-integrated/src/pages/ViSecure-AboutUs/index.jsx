...
const AboutUs = () => {
  ...
  useEffect(() => {
    document.title = 'Visecure System';
     ...
     <div className='aboutUsMain'>
      ...
      <div className="slider-container">
            <div className="slider-content" ref={sliderContentRef}>
                <div className="slide">
                    <h3>What We Offer</h3>
                    <p className="Header">Simplified Registration</p>
                ...
                <div className="slide">
                    <h3>What We Offer</h3>
                    <p className="Header">Enhanced Security</p>
                ...
                <div className="slide">
                    <h3>What We Offer</h3>            
                    <p className="Header">Real-Time Insights</p>
                ...
                <div className="slide">
                    <h3>What We Offer</h3>
                    <p className="Header">Customization</p>
                ...
                <div className="slide">
                    <h3>What We Offer</h3>
                    <p className="Header">User-Friendly Interface</p>
        ...
        {Array.from({ length: 5 }, (_, index) => (
          <React.Fragment key={index}>
            <input type="radio" name="slider" id={`slide${index + 1}`} ref={(el) => (inputRadiosRef.current[index] = el)} />
